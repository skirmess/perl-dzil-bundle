...
on develop => sub {
    ...
    requires 'Perl::Critic::Policy::Bangs::ProhibitBitwiseOperators', '1.14';
    requires 'Perl::Critic::Policy::Bangs::ProhibitDebuggingModules', '1.14';
    requires 'Perl::Critic::Policy::Bangs::ProhibitFlagComments', '1.14';
    requires 'Perl::Critic::Policy::Bangs::ProhibitRefProtoOrProto', '1.14';
    requires 'Perl::Critic::Policy::Bangs::ProhibitUselessRegexModifiers', '1.14';
    ...
    requires 'Perl::Critic::Policy::CodeLayout::ProhibitFatCommaNewline', '100';
    requires 'Perl::Critic::Policy::CodeLayout::RequireFinalSemicolon', '100';
    requires 'Perl::Critic::Policy::CodeLayout::RequireTrailingCommaAtNewline', '100';
    requires 'Perl::Critic::Policy::Community::AmpersandSubCalls', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::ArrayAssignAref', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::BarewordFilehandles', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::ConditionalDeclarations', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::ConditionalImplicitReturn', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::DeprecatedFeatures', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::DiscouragedModules', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::DollarAB', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::Each', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::IndirectObjectNotation', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::LexicalForeachIterator', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::LoopOnHash', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::ModPerl', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::MultidimensionalArrayEmulation', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::OpenArgs', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::OverloadOptions', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::POSIXImports', 'v1.0.4';
    ...
    requires 'Perl::Critic::Policy::Community::WarningsSwitch', 'v1.0.4';
    requires 'Perl::Critic::Policy::Community::WhileDiamondDefaultAssignment', 'v1.0.4';
    requires 'Perl::Critic::Policy::Compatibility::ConstantLeadingUnderscore', '100';
    requires 'Perl::Critic::Policy::Compatibility::ConstantPragmaHash', '100';
    requires 'Perl::Critic::Policy::Compatibility::ProhibitUnixDevNull', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitAdjacentLinks', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitBadAproposMarkup', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitDuplicateHeadings', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitLinkToSelf', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitParagraphEndComma', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitParagraphTwoDots', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitUnbalancedParens', '100';
    requires 'Perl::Critic::Policy::Documentation::ProhibitVerbatimMarkup', '100';
    requires 'Perl::Critic::Policy::Documentation::RequireEndBeforeLastPod', '100';
    requires 'Perl::Critic::Policy::Documentation::RequireFilenameMarkup', '100';
    requires 'Perl::Critic::Policy::Documentation::RequireLinkedURLs', '100';
    ...
    requires 'Perl::Critic::Policy::Modules::ProhibitModuleShebang', '100';
    requires 'Perl::Critic::Policy::Modules::ProhibitPOSIXimport', '100';
    requires 'Perl::Critic::Policy::Modules::ProhibitUseQuotedVersion', '100';
    requires 'Perl::Critic::Policy::Modules::RequireExplicitInclusion', '0.08';
    ...
    requires 'Perl::Critic::Policy::Subroutines::ProhibitExportingUndeclaredSubs', '0.08';
    requires 'Perl::Critic::Policy::Subroutines::ProhibitQualifiedSubDeclarations', '0.08';
    ...
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ConstantBeforeLt', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::NotWithCompare', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::PreventSQLInjection', '2.000001';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitArrayAssignAref', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitBarewordDoubleColon', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitDuplicateHashKeys', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitEmptyCommas', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitNullStatements', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitSingleArgArraySlice', '0.004';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::ProhibitUnknownBackslash', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::RequireNumericVersion', '100';
    requires 'Perl::Critic::Policy::ValuesAndExpressions::UnexpandedSpecialLiteral', '100';
    requires 'Perl::Critic::Policy::Variables::ProhibitLoopOnHash', '0.009';
